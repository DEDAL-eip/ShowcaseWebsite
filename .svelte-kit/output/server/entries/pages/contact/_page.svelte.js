...
<div class="h-screen bg-primary bg-gradient-to-tl from-secondary"><div class="py-10 px-72"><form action="/api/sendMail" method="POST" class="bg-white rounded space-y-2 p-6"><div class="text-secondary font-bold text-center text-4xl">Contact us</div>

      <div><label for="email" class="block">Email:</label>
        <input id="email" name="email" type="email" class="rounded border" required></div>
      <div><label for="object" class="block">Object:</label>
